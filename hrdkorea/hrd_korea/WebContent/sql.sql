...
teachar_name varchar2(15),
class_name varchar2(20),
class_price number(8),
teachar_regist_date varchar2(8)
);
...
select substr(c.regist_month, 1, 4), substr(c.regist_month, 5, 2), c.c_no, m.c_name, t.class_name, c.class_area, to_char(c.tuition, '999,999,999'), m.grade from tbl_member_202201 m, tbl_class_202201 c, tbl_teacher_202201 t where m.c_no = c.c_no and t.teacher_code = c.teacher_code;

select c.teacher_code, t.class_name, t.teachar_name, to_char(sum(c.tuition), '999,999,999') from tbl_teacher_202201 t, tbl_class_202201 c where t.teacher_code = c.teacher_code group by c.teacher_code, t.class_name, t.teachar_name order by c.teacher_code asc;